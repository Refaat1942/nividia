      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card">
          ...
          <table className="w-full text-sm">
            <thead><tr className="table-head"><th className="p-2 text-right">الاسم</th><th className="p-2 text-right">البريد</th><th className="p-2 text-right">الأدوار</th></tr></thead>
            <tbody>
              {users.map((u) => (
